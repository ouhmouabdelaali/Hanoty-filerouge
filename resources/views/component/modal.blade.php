  <div id="myModal{{$stock->product->id}}" class="myModal relative z-10 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
...
<!-- <button data-modal-target="myModal" class="showModalButton bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Show Modal 1</button> -->
...
document.querySelectorAll('.hideModalButton').forEach(function(button) {
  button.addEventListener('click', function() {
    var targetModalId = this.getAttribute('data-modal-target');
    var targetModal = document.getElementById(targetModalId);
    if (targetModal) {
